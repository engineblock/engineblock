...
public class LinkedInputTest {
    ...
    public void shouldBlockUntilLinkedAdvances() {
        Input goes2Kfast = new TargetRateInput(ActivityDef.parseActivityDef("targetrate=2000"));
        LinkedInput goesAsFast = new LinkedInput(ActivityDef.parseActivityDef("alias=asfast"),goes2Kfast);
    ...
    public void microBenchDiffRate() {
        ...
        Timer fastInputTimer = new NicerTimer(new DeltaHdrHistogramReservoir());
        Timer slowInputTimer = new NicerTimer(new DeltaHdrHistogramReservoir());
