...
public interface ResultFilterType extends Named {

    public static SimpleServiceLoader<ResultFilterType> FINDER =
            new SimpleServiceLoader<>(ResultFilterType.class);
