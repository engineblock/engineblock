...
import com.metawiring.load.activitycore.inputs.CycleSequenceSupplier;
    ...
    private ActivityExecutor getActivityExecutor(ActivityDef activityDef) {
        synchronized (activityExecutors) {
            ...
            if (executor == null) {
                ...
                ActivityType activityType = ActivityTypeFinder.get(activityTypeName);
                executor = ActivityLauncher.getExecutor(activityDef,activityType);
